...
export default function PendingOrders() {
    ...
    useEffect(() => {
        setOrders([
            { id: 201, customer: 'Rimi TanHa', product: 'Tablet', quantity: 1, total: 500, date: '2025-11-07', status: 'Pending' },
            { id: 202, customer: 'Arian Ahmed', product: 'Keyboard', quantity: 2, total: 100, date: '2025-11-08', status: 'Pending' },
            { id: 203, customer: 'Nazma Rima', product: 'Mouse', quantity: 1, total: 30, date: '2025-11-09', status: 'Pending' },
            { id: 204, customer: 'Ali Khan', product: 'Monitor', quantity: 1, total: 200, date: '2025-11-10', status: 'Pending' },
            { id: 205, customer: 'Sara Ali', product: 'Laptop', quantity: 1, total: 1000, date: '2025-11-11', status: 'Pending' },
            { id: 206, customer: 'John Doe', product: 'Keyboard', quantity: 2, total: 80, date: '2025-11-12', status: 'Pending' },
        ]);
    }, []);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <h1 className="mb-6 text-2xl font-bold">Pending Orders</h1>
