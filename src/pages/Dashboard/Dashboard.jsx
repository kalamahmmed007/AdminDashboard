...
const EnhancedAdminDashboard = () => {
  ...
  // API Configuration
  const API_BASE_URL = 'https://api.yourdomain.com'; // Replace with your actual API URL
  ...
  const loadMockData = () => {
    setDashboardData({
      ...
      stats: {
        ...
        totalOrders: 3847,
        pendingOrders: 156,
        completedOrders: 3691,
        totalRevenue: 892667.63,
        newCustomers: 234,
        todayRevenue: 12450.50,
        weekRevenue: 78234.80,
        monthRevenue: 324567.90,
        totalDiscounts: 15678.45,
        totalReturns: 8934.20
      },
      ...
      salesOverview: {
        revenueChart: [
          ...
          { date: 'Sun', revenue: 6900, orders: 69 }
        ],
        ordersChart: [
          { name: 'Pending', value: 156, color: '#fbbf24' },
          { name: 'Processing', value: 234, color: '#60a5fa' },
          { name: 'Completed', value: 3691, color: '#34d399' },
          { name: 'Cancelled', value: 89, color: '#f87171' }
        ],
        salesByCategory: [
          { category: 'Electronics', value: 145000, percentage: 35 },
          { category: 'Fashion', value: 112000, percentage: 27 },
          { category: 'Home & Garden', value: 87000, percentage: 21 },
          { category: 'Sports', value: 52000, percentage: 13 },
          { category: 'Books', value: 18000, percentage: 4 }
        ]
      },
      
      // Recent Orders
      recentOrders: [
        { id: '#ORD-2401', customer: 'John Smith', amount: 459.99, status: 'Completed', date: '2024-02-06 10:30 AM', items: 3 },
        { id: '#ORD-2402', customer: 'Emma Wilson', amount: 189.50, status: 'Processing', date: '2024-02-06 10:15 AM', items: 2 },
        { id: '#ORD-2403', customer: 'Michael Brown', amount: 799.99, status: 'Pending', date: '2024-02-06 09:45 AM', items: 1 },
        { id: '#ORD-2404', customer: 'Sarah Davis', amount: 324.75, status: 'Completed', date: '2024-02-06 09:20 AM', items: 5 },
        { id: '#ORD-2405', customer: 'James Miller', amount: 156.30, status: 'Processing', date: '2024-02-06 08:55 AM', items: 2 },
        { id: '#ORD-2406', customer: 'Lisa Anderson', amount: 689.99, status: 'Completed', date: '2024-02-06 08:30 AM', items: 4 },
        { id: '#ORD-2407', customer: 'Robert Taylor', amount: 234.50, status: 'Pending', date: '2024-02-06 08:10 AM', items: 3 },
        { id: '#ORD-2408', customer: 'Maria Garcia', amount: 445.80, status: 'Cancelled', date: '2024-02-06 07:45 AM', items: 2 }
      ],
      
      // Top Customers
      topCustomers: [
        { id: 1, name: 'Alice Johnson', email: 'alice@example.com', totalOrders: 48, totalSpent: 15678.90, avatar: '👩' },
        { id: 2, name: 'Bob Williams', email: 'bob@example.com', totalOrders: 42, totalSpent: 13456.50, avatar: '👨' },
        { id: 3, name: 'Carol Martinez', email: 'carol@example.com', totalOrders: 38, totalSpent: 11234.75, avatar: '👩' },
        { id: 4, name: 'David Lee', email: 'david@example.com', totalOrders: 35, totalSpent: 10567.30, avatar: '👨' },
        { id: 5, name: 'Eve Thompson', email: 'eve@example.com', totalOrders: 32, totalSpent: 9845.20, avatar: '👩' }
      ],
      
      // Recent Customers
      recentCustomers: [
        { id: 1, name: 'Frank White', email: 'frank@example.com', joinDate: '2024-02-06', status: 'Active', avatar: '👨' },
        { id: 2, name: 'Grace Hall', email: 'grace@example.com', joinDate: '2024-02-06', status: 'Active', avatar: '👩' },
        { id: 3, name: 'Henry Clark', email: 'henry@example.com', joinDate: '2024-02-05', status: 'Active', avatar: '👨' },
        { id: 4, name: 'Iris King', email: 'iris@example.com', joinDate: '2024-02-05', status: 'Pending', avatar: '👩' }
      ],
      
      // Low Stock Products
      lowStockProducts: [
        { id: 1, name: 'Wireless Headphones', sku: 'WH-001', currentStock: 5, threshold: 20, category: 'Electronics', price: 89.99 },
        { id: 2, name: 'Smart Watch', sku: 'SW-045', currentStock: 3, threshold: 15, category: 'Electronics', price: 199.99 },
        { id: 3, name: 'Running Shoes', sku: 'RS-234', currentStock: 8, threshold: 25, category: 'Sports', price: 79.99 },
        { id: 4, name: 'Coffee Maker', sku: 'CM-789', currentStock: 4, threshold: 10, category: 'Home', price: 129.99 },
        { id: 5, name: 'Yoga Mat', sku: 'YM-456', currentStock: 6, threshold: 20, category: 'Sports', price: 34.99 }
      ],
      ...
      abandonedCarts: {
        ...
        weekCount: 67,
        topProducts: [
          { product: 'Laptop Pro 15"', count: 18, value: 2699.99 },
          { product: 'Gaming Mouse', count: 15, value: 79.99 },
          { product: 'Mechanical Keyboard', count: 12, value: 149.99 },
          { product: '4K Monitor', count: 10, value: 499.99 },
          { product: 'USB-C Hub', count: 8, value: 59.99 }
        ]
      },
      
      // Support Tickets
      supportTickets: [
        { id: '#TKT-1001', customer: 'John Doe', issue: 'Payment not processed', status: 'Open', priority: 'High', date: '2024-02-06 11:00 AM' },
        { id: '#TKT-1002', customer: 'Jane Smith', issue: 'Product defect', status: 'In Progress', priority: 'Medium', date: '2024-02-06 10:30 AM' },
        { id: '#TKT-1003', customer: 'Mike Johnson', issue: 'Shipping delay inquiry', status: 'Open', priority: 'Low', date: '2024-02-06 09:45 AM' },
        { id: '#TKT-1004', customer: 'Emily Davis', issue: 'Refund request', status: 'Resolved', priority: 'High', date: '2024-02-06 09:00 AM' },
        { id: '#TKT-1005', customer: 'Chris Wilson', issue: 'Account access issue', status: 'In Progress', priority: 'Medium', date: '2024-02-06 08:15 AM' }
      ],
      
      // System Notifications
      systemNotifications: [
        { id: 1, title: 'System Update Available', message: 'Version 2.5.0 is ready to install', time: '10 mins ago', type: 'info', read: false },
        { id: 2, title: 'Backup Completed', message: 'Database backup successful', time: '1 hour ago', type: 'success', read: false },
        { id: 3, title: 'High Server Load', message: 'Server CPU usage at 85%', time: '2 hours ago', type: 'warning', read: true },
        { id: 4, title: 'New Integration Available', message: 'Connect with Shopify now', time: '3 hours ago', type: 'info', read: true }
      ],
      
      // Pending Approvals
      pendingApprovals: [
        { id: 1, type: 'Product Return', customer: 'Alice Brown', amount: 299.99, date: '2024-02-06', urgent: true },
        { id: 2, type: 'Bulk Discount', customer: 'XYZ Corp', amount: 5000.00, date: '2024-02-06', urgent: false },
        { id: 3, type: 'Vendor Payment', vendor: 'ABC Supplies', amount: 15000.00, date: '2024-02-05', urgent: true },
        { id: 4, type: 'Product Upload', seller: 'Tech Store', items: 45, date: '2024-02-05', urgent: false }
      ],
      
      // Payment Failures
      paymentFailures: [
        { id: 1, orderId: '#ORD-2389', customer: 'Tom Harris', amount: 456.78, reason: 'Insufficient funds', time: '30 mins ago' },
        { id: 2, orderId: '#ORD-2390', customer: 'Lucy Parker', amount: 189.99, reason: 'Card expired', time: '1 hour ago' },
        { id: 3, orderId: '#ORD-2391', customer: 'Sam Turner', amount: 799.50, reason: 'Payment gateway error', time: '2 hours ago' }
      ],
